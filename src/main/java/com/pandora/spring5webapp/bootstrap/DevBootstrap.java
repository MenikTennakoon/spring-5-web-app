...
import com.pandora.spring5webapp.model.Publisher;
...
import com.pandora.spring5webapp.repositories.PublisherRepository;
...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void initData() {
        ...
        Book noEJB = new Book("J2EE Development without EJB", publisher);
